...
export class WindowClass {
   ...
   getDefaultDockId() {
      const { windowsDocks } = this.context
...
export class WindowInstance extends Listenable {
   ...
   constructor(windowId: string, windowClass: WindowClass,
      ...
      windowClass.context.windows[windowId] = this
   ...
   get context() {
      return this.windowClass.context
   }
   get hasFocus() {
...
export class WindowContainer extends React.Component<PropsType> {
...
export class WindowComponent<TFeatureInstance extends FeatureInstance = FeatureInstance> extends Component {
   ...
   openWindow(windowClassID: string, options: WindowOptions) {
      ...
      windowClass.context.openSubWindow(windowClass.windows[windowClassID], this.instance, options)
   }
   closeWindow() {
      const { windowClass } = this.instance
      windowClass.context.removeWindow(this.instance)
   }
