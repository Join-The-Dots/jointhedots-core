...
export default class LinearContainer extends React.Component<PropsType> {
   delta: number = 0.0
...
const className_V = "rvframe-linear-container vertical "
const className_H = "rvframe-linear-container horizontal "
