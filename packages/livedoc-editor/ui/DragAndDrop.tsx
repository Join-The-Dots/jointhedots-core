...
export class DragZone extends React.Component<DragPropsType> {
...
export class DropZone<P extends DropPropsType = DropPropsType> extends React.Component<P> {
...
export class DragDropZone extends DropZone<DragPropsType & DropPropsType> {
