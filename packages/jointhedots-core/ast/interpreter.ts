...
const BINARY_OPERATIONS = new Map<string, (l: unknown, r: unknown) => unknown>([
...
const UNARY_OPERATIONS = new Map<string, (v: unknown) => unknown>([
   ['-', (v) => -(v as any)],
   ['+', (v) => +(v as any)],
   ['!', (v) => !v],
   ['~', (v) => ~(v as any)],
...
const ASSIGNMENT_OPERATIONS = new Map<string, (current: unknown, right: unknown) => unknown>([
   ['=', (_, r) => r],
...
const ENHANCED_BINARY_OPERATIONS = new Map<string, (l: unknown, r: unknown) => unknown>([
   ...BINARY_OPERATIONS,
   ['<<', (l, r) => (l as any) << (r as any)],
   ['>>', (l, r) => (l as any) >> (r as any)],
   ['>>>', (l, r) => (l as any) >>> (r as any)],
...
const ENHANCED_ASSIGNMENT_OPERATIONS = new Map<string, (current: unknown, right: unknown) => unknown>([
...
const ENHANCED_LOGICAL_OPERATIONS = new Map<string, (l: unknown, r: unknown, scope: InterpreterScope) => unknown>([
