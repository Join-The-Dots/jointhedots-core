...
import { ComponentEntry, ComponentManifest, ComponentsRegistry, ServiceInterface, ServiceType } from "@sf-explorer/core"
import { ComponentDriverService } from "@sf-explorer/core/services/ComponentDriver"
import { ChangeSetId, FileKey, StorageChangeLog, StorageChangeSet, StorageChangeStatus, StorageService, StorageStats, StorageTransaction } from "@sf-explorer/core/services/Storage"
...
export const GithubDriverService: ComponentDriverService = {
   ...
   getDefinition(): ComponentEntry {
      return ComponentsRegistry.acquireComponent("sfe:github.service")
   },
