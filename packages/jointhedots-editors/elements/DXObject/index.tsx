...
import { PropertyDecoration, PropertyRow, PropertyTable } from '@jointhedots/editors/elements/ui/TableProperties'
import { ElementsEditors } from '..'
import {
   CommonTypes, DocumentationSchema, MapLike, Schema, JSONSchema,
   ElementJSON, DXObject, ObjectProperty, serializeElement
...
export function ObjectEditor(props: ValueProps<DXObject>) {
