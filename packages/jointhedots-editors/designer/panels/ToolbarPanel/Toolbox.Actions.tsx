...
import DropDown, { DropDownItem } from '@jointhedots/editors/designer/ui/DropDown';
import { useSettings } from '@jointhedots/editors/designer/context/SettingsContext';
...
export default function ActionsToolbar(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <DropDownItem
        className="item"
        onClick={() => viewEditor.openPanel("comments")}
      >
      ...
      <DropDownItem
        ...
        onClick={() => viewEditor.openPanel("tree-view")}
      >
      ...
      <DropDownItem
        className="item actions"
        onClick={() => viewEditor.openPanel("markdown-view")}
      >
