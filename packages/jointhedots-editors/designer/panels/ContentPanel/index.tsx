...
import { MARKDOWN_TRANSFORMERS } from '@jointhedots/editors/designer/markdown/markdown-to-lexical'
import { InstrumentationSupport } from '@jointhedots/ui/Instrumentation'
...
function Editor(): JSX.Element {
  ...
  return (<div className="jointhedots-editor">
