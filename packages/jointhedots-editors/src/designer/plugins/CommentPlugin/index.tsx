...
import { PanelComponent, PanelDescriptor, useFeature } from '@jointhedots/editors/ui/FeaturesLayout'
...
export default function CommentPlugin({
  ...
  const collabContext = useCollaborationContext();
  const [editor] = useLexicalComposerContext();
  const commentStore = React.useContext(CommentStoreContext);
...
export class CommmentsPanel extends PanelComponent<ViewEditor> {
  static descriptor: PanelDescriptor = {
    layouting: "flexible",
    defaultTitle: "Commments",
    defaultIcon: "bi:chat-square-text",
    defaultDockId: "right",
  }
  render() {
    return <CommmentsView />
  }
}
