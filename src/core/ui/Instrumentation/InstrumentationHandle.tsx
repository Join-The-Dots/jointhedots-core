...
import { executeZoneCommand, ElementTooling, ElementInstrumentation, ElementController, InstrumentationKind, ElementCommand } from "."
...
export class InstrumentationToolBox extends React.Component implements ElementTooling {
   ...
   setDescriptor(descriptor: any) {
      const { zone } = this.props
      return zone.setDescriptor(descriptor)
   }
