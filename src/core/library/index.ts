...
ComponentsRegistry.content_provider = new StaticComponentContent()
ComponentsRegistry.components_provider = new StaticComponentProvider(ComponentsRegistry.content_provider)
